...
namespace SSEcommerceWebApp.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user =  _userManager.Users.FirstOrDefault(x => x.PhoneNumber == Input.PhoneNumber);

                if (user == null)
                {
                    ModelState.AddModelError("NoUserError", "No user found with this email");
                    return Page();
                }
